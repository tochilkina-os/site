const yearData = [
  ...
  },
  {
    ...
    size1: "Сводная таблица, DOCX",
    href1: "./monitoring/2026 СВОДНАЯ  ТАБЛИЦА ПО УСВОЕНИЮ ПРОГРАММНЫХ ПОКАЗАТЕЛЕЙ ДЕТЬМИ гр. Светлячки 1-я младшая гр 25-26.docx",
    title2: "Аналитическая справка 2025-2026",
    size2: "Выводы и рекомендации, DOCX",
    href2: "./monitoring/2026 Аналитическая справки по итогам педагогической диагностики 25-26.docx",
    group: "1-я младшая группа «Светлячки», 15 детей",
    total: "37%",
    firstHalfTotal: 6,
    secondHalfTotal: 37,
    label1: "Социально-коммуникативное развитие",
